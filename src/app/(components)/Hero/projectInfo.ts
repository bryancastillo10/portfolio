...
export const projectInfo = [
    ...
    },
    {
        ...
        projectSubtitle:"Clone of Famous Accomodation Booking App",
        description:"Imitating the key features of the popular accommodation reservation app that further provides me insights on how to work on databases. This app has authentication, user reservation, user likings, and ability to add their own places as an accomodation",
        techStack:["Next JS","MongoDB","Prisma", "Tailwind CSS"],
        image:AirBnbCloneImg.src,
