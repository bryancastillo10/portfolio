    ...
    <div className="w-full min-h-screen">
       <section style={backgroundStyle}>
          <div className="max-w-[80%] mx-auto container pt-20">
            {/* Hero Header */}
            <div className={`my-4 md:p-4 flex flex-col gap-4 text-center md:text-left rounded-2xl max-w-[80%] xl:max-w-[50%] mx-auto md:mx-0
              ...
              <div className="min-w-fit md:max-w-full py-4 ">
                <p className="md:font-medium leading-sm text-center md:text-left text-xl md:text-2xl max-w-[90%] mx-auto md:mx-0">
