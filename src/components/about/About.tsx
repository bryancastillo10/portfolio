      ...
      <div className="max-w-[80%] mx-auto">
        <div className="flex flex-col-reverse lg:flex-row gap-x-24">
          ...
          <article className="flex items-center relative my-20 md:my-0">
            ...
            md:right-8 lg:top-20 lg:right-0 z-10 size-[120px] md:size-[150px]"
            ...
            {/* Carbon Hexagon */}
            <Image className="absolute left-[-20px] bottom-[-30%] md:bottom-[-15%]
            lg:bottom-[10%] size-[120px] md:size-[150px]" src={carbonHexagon} alt="carbon-hex" />
            
            {/* Dark Blue Hexagon */}
            <Image className="absolute right-[20%] md:right-[30%] lg:right-[40%] bottom-[-40%] md:bottom-[-30%]
            lg:bottom-[-2%] size-[120px] md:size-[150px]" src={darkBlueHexagon} alt="darkblue-hex" />
          </article>
        </div>
      </div> 
    </section>
