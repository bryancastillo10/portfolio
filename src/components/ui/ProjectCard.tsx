...
const ProjectCard = () => {
	const sampleTags = ["web-application", "mern","fullstack-development", "prisma","redux-toolkit","dashboard-analysis","clean-architecture"]
  ...
  return (
	<div className="w-sm md:w-md xl:w-lg min-h-80 border rounded-xl shadow-lg grid grid-cols-2 p-2">
		...
		<div>
			...
			<div className="px-2">
				...
				<ul className="grid grid-cols-3 gap-2 my-3">
					<li className="flex flex-col items-center"><Star/> 3</li>
					<Link href="#"><li className="hover:scale-90 duration-200 ease-in-out"><FolderGit2/></li></Link>
					<Link href="#"><li className="hover:scale-90 duration-200 ease-in-out"><MonitorPlay/></li></Link>
				</ul>
			</div>
		</div>
		...
		<div className="p-2 flex flex-col gap-2">
			...
			<p className="text-xs text-left">A Dashboard Analytics Web App for Water Quality Monitoring Built with MERN-Typescript</p>
