        ...
        <div className="pt-36 lg:pt-60">
          ...
          >
            <div className="p-2 md:p-4 flex flex-col gap-4 text-center md:text-left">
              <h1
                className={`font-bold text-5xl lg:text-7xl leading-tight tracking-wider ${adventPro.className}`}
              >
                Bryan Castillo
              </h1>
              <div className="min-w-fit md:max-w-full mx-auto py-4">
                <p
                  className="md:font-medium leading-sm md:text-left
               text-xl md:text-2xl
              "
                >
